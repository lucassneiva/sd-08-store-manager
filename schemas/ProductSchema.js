...
const getMessage = async(name, quantity, data) => {
  switch (true) {
  case isLenghtNLetterThan(name, MIN_LENGTH_NAME): return errors.name_length;
  case await isNotRepeat(name, data): return errors.name_repeat;
  case isLenghtQLetterThan(quantity, MIN_LENGTH_QUANTITY): return errors.quantity_length;
